...
\index{Herleitung der Compton-Formel}


%\section{Herleitung der Compton-Formel}
\subsection*{Ein Photon stößt auf ein Elektron}
\index{Photon nach Stoß}
\index{Elektron nach Stoß}
\begin{center}
...
\index{Energieübertragung}
\index{Photon gestreut}
\index{Compton-Effekt}
\index{Photonenenergie}
...
\end{DidacticBox}
\index{Verschiebung}
\index{Energieerhlatung}
\subsection{Die Energieerhaltung bei dem Stoß}
\[
E_\gamma + E_e = E'_\gamma + E'_e
\]
\index{Photon einfallend}
\index{Elektron vor dem Stoß}
\index{Elekton nach dem Stoß}
\begin{align*}
...
\index{Herleitung}
\index{Impuls-Ausdruck}
\index{Impulsgleichung}
\index{Stoß}
...
\index{Wellenlängenvergrößerung}
\index{Röntgenstrahlung}
...
\index{Masse}
\index{Ruhemasse}
\index{Compton-Verschiebung}
\index{hypothetische Ruhemasse}
\index{Präzisionsmessung}
